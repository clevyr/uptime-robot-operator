// Code generated by "enumer -type PortType -trimprefix Port -json -text"; DO NOT EDIT.
...
func (i PortType) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for PortType
func (i *PortType) UnmarshalText(text []byte) error {
	var err error
	*i, err = PortTypeString(string(text))
	return err
}
